...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function respondToUser(userText) {
    ...
    if (lowercase.includes('clube') || lowercase.includes('grupo') || lowercase.includes('alerta')) {
      reply = "No DIJA Club você recebe alertas diários direto no WhatsApp! Clique no botão de compra ou fale com nossa equipe para garantir seu acesso com desconto.";
      ...
      reply = "Temos o DIJA Club a partir de R$ 19,90/mês e a Consultoria Personalizada por apenas R$ 150 por viagem. Qual plano você gostaria de saber mais?";
    } else if (lowercase.includes('oi') || lowercase.includes('ola') || lowercase.includes('bom dia') || lowercase.includes('boa tarde')) {
      reply = "Olá! Eu sou o assistente virtual da DIJA. Você gostaria de conhecer o DIJA Club ou nossa Consultoria de Viagens Personalizada?";
    }
